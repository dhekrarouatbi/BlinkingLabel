...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dhekra Rouatbi/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dhekra Rouatbi' => 'dhekra.rouatbi@proxym-it.com' }
  s.source           = { :git => 'https://github.com/Dhekra Rouatbi/BlinkingLabel.git', :tag => s.version.to_s }
